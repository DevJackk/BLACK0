...
redis:set(black.."GAME:JACK"..msg.chat_id_,'الطاوس')
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
if (msg.text == redis:get(black.."GAME:JACK"..msg.chat_id_)) and redis:get(black.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'【▣】شاطر انتا صح 【▣】')     
redis:incrby(black..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(black.."GAME:S"..msg.chat_id_)
redis:del(black.."GAME:JACK"..msg.chat_id_)
