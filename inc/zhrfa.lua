...
redis:setex(JACK..":ZhrfNow:"..msg.sender_user_id_,500,true)
sendMsg(msg.chat_id_,msg.id_,"⚶ | حسننا , الان يمكنك ارسال الاسم شكرا لستخدامك سورس جاك و الجوكر  ☆")    
return false
end

if redis:get(JACK..":ZhrfNow:"..msg.sender_user_id_) then
redis:del(JACK..":ZhrfNow:"..msg.sender_user_id_)
...
if msg.text and msg.type ~= "pv" and redis:get(JACK..":ZhrfNow:"..msg.sender_user_id_) then
Text = msg.text
redis:del(JACK..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
...
.."`\n\n9- `"..Zhrf9..Emoje[math.random(#Emoje)]
.."`\n\n10- `"..Zhrf5..Emoje[math.random(#Emoje)]
Text_Zhrfa = Text_Zhrfa.."`\n\n✎| اضغط علي الاسم ليتم النسخ شكرا لستخدامك سورس جاك و الجوكر \n✓"
sendMsg(msg.chat_id_,msg.id_,Text_Zhrfa)
return false
end
