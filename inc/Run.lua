...
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @BLACK_TEAM_3 }• }•\e[0m"
...
echo -e "\e[38;5;77m      BLACK ✾ @V_P_Ee[0m"
...
..'¦ Run_Scrpt: \27[1;34m./inc/Script2.lua\027[0;32m \n'
...
local ok, i =  pcall(function() ScriptFile= loadfile("./inc/Script2.lua")() end)
if not ok then 
print('\27[31m! Error File Not "Run inc/Script2.lua" !\n\27[39m')
print(tostring(io.popen("lua inc/Script2.lua"):read('*all')))
end
...
local GetMsg = ScriptFile.iblack(msg,{msg.text:match(black)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",black.." | Plugin is: \27[1;32mScript2.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end
end
...
print("\27[1;35m¦Msg_IN_Process : Proc _ Script2.lua\27[0m")
end
...
print("The File Script2.lua Not Runing in The Source black")
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/jack1eljoker1/BLACK123321123321BLACK/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/BLACK123321123321BLACK/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/BLACK123321123321BLACK/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
    download_file('https://raw.githubusercontent.com/jack1eljoker1/BLACK123321123321BLACK/main/inc/Script2.lua','./inc/Script2.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/BLACK123321123321BLACK/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/BLACK123321123321BLACK/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/jack1eljoker1/BLACK123321123321BLACK/main/plugins/games.lua','./plugins/games.lua')
