...
Jack = msg.text
if Jack then
if redis:sismember(black..'CmDlist:'..msg.chat_id_,Jack) then
mmdi = redis:hget(black..'CmD:'..msg.chat_id_,Jack)
msg.text = Jack:gsub(Jack,mmdi)
end
end
