...
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Black:insta_bot"..msg.chat_id_) == "open" then
...
xsudouser = SUDO_USER:gsub('@','')
xsudouser = xsudouser:gsub([[\_]],'_')
local inline = {{{text="-مبرمج السورس",url="https://t.me/V_P_E"}}}
send_key(msg.sender_user_id_,'   مبرمج السورس جاك' ,nil,inline,msg.id_)
return false
end
