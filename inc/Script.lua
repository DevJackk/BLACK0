...
if MsgText[1]== "سورس" and msg.type == "pv" then
local inline = {{{text=" ❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ❍"}}}
send_key(msg.sender_user_id_,'   ❍ 𝐷𝐸𝑉 >> [˹ 𝐽𝐴𝐶𝐾 .](t.me/V_P_E)' ,nil,inline,msg.id_)
send_key(msg.sender_user_id_,'   ❍ 𝐷𝐸𝑉 >> [˹ 𝐸𝐿 𝐽𝑂𝐾𝐸𝑅 .](t.me/A_j_o_k_e_r)' ,nil,inline,msg.id_)
send_key(msg.sender_user_id_,'   ❍ 𝐷𝐸𝑉 >> [˹ 𝑀𝐴𝑁𝐷𝑂 .](t.me/Mdo_Fs)' ,nil,inline,msg.id_)
send_key(msg.sender_user_id_,'   ❍ـــ❍ >> [˹ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 .](t.me/BLACK_TEAM_3)' ,nil,inline,msg.id_)
send_key(msg.sender_user_id_,'   ❍ـــ❍>> [˹ 𝑇𝑂 𝑇𝐴𝐿𝐾 𝐹𝑂𝑅 𝑈𝑆 .](t.me/BB00OT_BoT)' ,nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "المطور ماندو" and msg.type == "pv" then
local inline = {{{text="-مطور السورس اضـغـط هـنـآ ",url="https://t.me/Mdo_Fs"}}}
send_key(msg.sender_user_id_,'   [مطور السورس](https://t.me/Mdo_Fs)' ,nil,inline,msg.id_)
return false
end
...
redis:setex(black..":propin"..data.chat_id_,100,data.content_.text_)
end)
end
...
elseif Text== "محمد سمير" or Text== "ماندو" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس بلاك ](https://t.me/Mdo_Fs)")
elseif Text== "سورس بلاك" or Text== "سورس بلاك" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد سورس مصري ](https://t.me/BLACK_TEAM_3)")
