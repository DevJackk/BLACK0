...
if($text !== "/start" and $text !== "/admin" && $from_id !== $sudo){
bot('SendMessage',[
'chat_id'=>$sudo,
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎", 'parse_mode' => "MarkDown", 'disable_web_page_preview' => true, 'reply_markup' => json_encode(['inline_keyboard' => [[['text' => "• اضغط هنا وتابع جديدنا 🇮🇶؛", 'url' => "https://t.me/M1_m2s"]], ]]) ]);
}
#ᎷΘᎻᎪᎷᎬᎠ_ᎤᎪᏆᏕ𖤍
# ﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎  #
