...
redis:setex(black..':fwd:JA:'..msg.chat_id_..msg.sender_user_id_,300, true) 
...
black..':fwd:JA:'..msg.chat_id_..msg.sender_user_id_,
...
{"تعطيل البوت خدمي","تفعيل البوت خدمي","المطورين"},
 ...
 {"اذاعه","اذاعه خاص"},
{"اذاعه عام","اذاعه بالتثبيت","اذاعه عام بالتوجيه"},
...
if redis:get(black..':fwd:JA:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(black..':fwd:JA:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(black..'group:ids')
if #groups >= 300 then
