...
local text = [[
 ...
 【▣】انصحني ➢ لكي يعطيك البوت بعض النصائح .
...
elseif Text== "طيب" or Text== "عمار حسني طيب" then return  sendMsg(msg.chat_id_,msg.id_,"[@J_A_C_K_5_Bot 1](https://t.me/J_A_C_K_5_Bot 1)")
...
elseif Text== "ايدي" then return sendMsg(msg.chat_id_,msg.id_,"رجلي")
...
elseif Text== "الرتبه" then return sendMsg(msg.chat_id_,msg.id_,"تدفع كام واقولك/nولا اقولك صعبت عليا/nهقولك /n")
elseif Text== "جهاتي" then return sendMsg(msg.chat_id_,msg.id_,"عاوز اقولك جهاتك 0/nبس الضمير بقا/n")
