...
【▣】سيفي ➢ سيقوم البوت بإخبارك عن نفسه. 
...
if MsgText[1]== 'سيفي' or MsgText[1]=='سي في' or MsgText[1]=='cv' or MsgText[1]=='Cv' or MsgText[1]=='CV' or MsgText[1]==' cV' then
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير,المطور} فقط  \n❍ " end
local text = [[
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
انا بوت ادعي : [["NameBot"]]
عمري : [["$uptime"'*']]
سورسي : سورس بلاك
قناه سورسي : [[@BLACK_TEAM_3]]
مطوري :  ]]..SUDO_USER..[[ 
مبرمج سورسي : جاك
معرف مبرمجي : [[@V_P_E]]
مكان اقامتي : تيليجرام
