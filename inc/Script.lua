...
if MsgText[1]== "مصنع بوتات جاك" and msg.type == "pv" then
local inline = {{{text="-مصنع بوتات جاك اضـغـط هـنـآ ",url="https://t.me/J_A_C_K_0_Bot"}}}
send_key(msg.sender_user_id_,'   [مصنع بوتات جاك](https://t.me/J_A_C_K_0_Bot)' ,nil,inline,msg.id_)
return false
end
