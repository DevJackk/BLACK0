...
local inline = {{{text="-مبرمج آلسـورس اضـغـط هـنـآ ",url="https://t.me/V_P_E_1"}}}
send_key(msg.sender_user_id_,'   [مبرمج السورس جاك](https://t.me/V_P_E_1)' ,nil,inline,msg.id_)
return false
end
...
elseif Text== "جاك" or Text== "جاك" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس جاك](https://t.me/V_P_E_1)")
