...
local inline = {{{text="-مطور السورس اضـغـط هـنـآ ",url="https://t.me/Q_Y_4"}}}
send_key(msg.sender_user_id_,'   [مطور السورس](https://t.me/Q_Y_4)' ,nil,inline,msg.id_)
return false
end
...
elseif Text== "ادهم" or Text== "ادهم" then return  sendMsg(msg.chat_id_,msg.id_,"[مبرمج سورس بلاك ](https://t.me/Q_Y_4)")
