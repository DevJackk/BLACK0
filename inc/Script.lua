...
if MsgText[1] == "اسبام رسائل" or MsgText[1]=="اسبام رسائلthen
return [[
【▣】رسائل اسبام
...
if MsgText[1] == "اداة darkfly" or MsgText[1]=="اداة darkfly" then
return [[
اداة darkfly【▣】
...
if MsgText[1] == "اداة weeman" or MsgText[1]=="اداة weeman" then
return [[
اداة weeman【▣】
