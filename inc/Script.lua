...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/BLACK_TEAM_4"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : بلاك](https://t.me/BLACK_TEAM_4)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المبرمج جاك" and msg.type == "pv" then
local inline = {{{text="-مبرمج آلسـورس اضـغـط هـنـآ ",url="https://t.me/PHP57"}}}
send_key(msg.sender_user_id_,'   [مبرمج السورس جاك](https://t.me/PHP57)' ,nil,inline,msg.id_)
return false
end
...
elseif Text== "جاك" or Text== "خالد" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد من القمدان يبرو](https://t.me/PHP57)")
elseif Text== "الجوكر" or Text== "الجوكر" then return  sendMsg(msg.chat_id_,msg.id_,"[عم التيلي ياهه ](https://t.me/A_j_o_k_e_r)")
elseif Text== "سورس بلاك" or Text== "سورس بلاك" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد سورس مصري ](https://t.me/BLACK_TEAM_4)")
...
elseif Text== "سورس" then return sendMsg(msg.chat_id_,msg.id_,"انتا ازاي مش عارف/nان انا علي افجر علي/nسورس مصري/n سورس بلاك/n")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/BLACK_TEAM_4) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/BLACK_TEAM_4)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/BLACK_TEAM_4)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/BLACK_TEAM_4)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/BLACK_TEAM_4)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/BLACK_TEAM_4) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/BLACK_TEAM_4)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/BLACK_TEAM_4)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/BLACK_TEAM_4)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/BLACK_TEAM_4)")
