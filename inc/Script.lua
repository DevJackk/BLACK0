...
local inline = {{{text="-مبرمج آلسـورس اضـغـط هـنـآ ",url="https://t.me/B_6_6_B"}}}
send_key(msg.sender_user_id_,'   [مبرمج السورس جاك](https://t.me/B_6_6_B)' ,nil,inline,msg.id_)
return false
end
...
elseif Text== "جاك" or Text== "خالد" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد من القمدان يبرو](https://t.me/B_6_6_B)")
